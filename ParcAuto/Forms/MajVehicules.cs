            ...
            if (!(txtMarque.Text == "" || txtAffectation.Text == "" ||  txtCarburant.Text == ""))
            {
                switch (Commandes.Command)
                {
                    case Choix.ajouter:
                        ...
                        GLB.Cmd.Parameters.AddWithValue("@TempMatricule", Source.GetType().Name == "VehiculesPRD" ? cmbConducteur.SelectedItem : (((CmbMatNom)cmbConducteur.SelectedItem).Matricule ?? (object) DBNull.Value ));
